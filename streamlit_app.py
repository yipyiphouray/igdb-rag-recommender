...
st.caption("Pick a path: browse the catalog, find hidden gems, get guided recommendations, or inspect the analytics.")
...
with row1[1]:
    render_menu_card(
        "Hidden Gems",
        "Surface reliable high-rated games with lower known visibility inside the project sample.",
...
with row1[2]:
    render_menu_card(
        "Recommendations",
        "Answer guided preference questions and get ranked, explainable game suggestions.",
...
with row2[0]:
    render_menu_card(
        "Insights",
        "A dashboard-style page for descriptive and diagnostic findings.",
        "pages/6_Insights.py",
        "Open Insights",
    )
with row2[1]:
    render_menu_card(
        "Methodology",
        "The academic/trust page with sources, formulas, caveats, and calculation logic.",
